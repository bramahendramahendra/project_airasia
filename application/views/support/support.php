...
<div class="container">
      <h1 class="bantuan">Bantuan Pelanggan</h1>
      <h5 class="text-center">Apakah anda memiliki pertanyaan? izinkan kami membantu anda</h5>
    </div>
  </div>
<br>
<br>
...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      <h1 class="informasi">Informasi perjalanan</h1>
          <ul class="Airasia">
            <li style="font-family: 'Roboto',sans-serif; font-size: 14px;">AirAsia secara permanen menarik penjualan penerbangan dari agen perjalanan online, Traveloka di semua rute di jaringannya.<a href="#" >Dapatkan informasi lebih lanjut di sini</a></li>
            <li style="font-family: 'Roboto',sans-serif; font-size: 14px;">Pemerintah Malaysia dengan tegas melarang masuknya produk-produk berbahan dasar daging babi dan babi ke Malaysia.<a href="#">Dapatkan informasi lebih lanjut disini.</a></li>
            <li style="font-family: 'Roboto',sans-serif; font-size: 14px;">AirAsia memindahkan operasi penerbangan di Bandara Internasional Chhatrapati Shivaji Mumbai dari Terminal 1B ke Terminal 2 mulai 15 April 2019</li>
          </ul>
          <br>
          <br>
          ...
          <div class="row">
            <div class="col-sm-4">
                <div class="container-kotak">
                  <a href="#"></a>
                  <img src="<?php echo base_url()?>Assets/img/order.png" height="100">
                  <p class="text-center" style="font-family: 'Roboto',sans-serif; font-size: 16px; color : black; font-weight: 700px">Pemesanan Penerbangan</p>
                </div>
            ...
            <div class="col-sm-4">
                <div class="container-kotak">
                    <a href="#"></a>
                    <img src="<?php echo base_url()?>Assets/img/baggage.png" height="100">
                    <p class="text-center" style="font-family: 'Roboto',sans-serif; font-size: 16px; color : black; font-weight: 700px">Bagasi</p>
                  </div>
            </div>
            <div class="col-sm-4">
                <div class="container-kotak">
                  <a href="#"></a>
                  <img src="<?php echo base_url()?>Assets/img/credit-card.png" height="100">
                  
                  <p class="text-center" style="font-family: 'Roboto',sans-serif; font-size: 16px; color : black; font-weight: 700px">Pengembalian Dana</p>
                </div>
         ...
         <div class="container">
          <div class="row">
            <div class="col-sm-4">
                <div class="container-kotak">
                  <a href="#"></a>
                  <img src="<?php echo base_url()?>Assets/img/contacts.png" height="100">
                  <p class="text-center" style="font-family: 'Roboto',sans-serif; font-size: 16px; color : black; font-weight: 700px">Check in</p>
                </div>
            ...
            <div class="col-sm-4">
                <div class="container-kotak">
                  <a href="#"></a>
                    <img src="<?php echo base_url()?>Assets/img/disabled.png" height="100">
                    <p class="text-center" style="font-family: 'Roboto',sans-serif; font-size: 16px; color : black; font-weight: 700px">Tamu dengan kebutuhan Khusus</p>
                  </div>
            </div>
            <div class="col-sm-4">
                <div class="container-kotak">
                  <a href="#"></a>
                  <img src="<?php echo base_url()?>Assets/img/customer-service.png" height="100">
                  <p class="text-center" style="font-family: 'Roboto',sans-serif; font-size: 16px; color : black; font-weight: 700px">Produk dan layanan</p>
                </div>
